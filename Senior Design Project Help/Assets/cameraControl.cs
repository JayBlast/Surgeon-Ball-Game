...
public class cameraControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        player = FindObjectOfType<rollingIt>();  // Find player
    ...
    void FixedUpdate()
    {
        if (player.currentState == rollingIt.State.NORMAL)
        {
    ...
    void LateUpdate()
    {
        ...
        {
            case rollingIt.State.WAIT:
                SpiralProcedure();
                break;
            case rollingIt.State.NORMAL:
                // Follow the player
                FollowTarget();
                break;
            case rollingIt.State.DEAD:
    ...
    void StartStage()
    {
        player.currentState = rollingIt.State.NORMAL;
    }
